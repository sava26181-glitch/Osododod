...
async function buildCs2Catalog() {
    ...
    // Один запрос schema + один полный snapshot цен параллельно.
    // cs2.sh прямо рекомендует GET /v1/prices/latest для локальной таблицы цен.
    const [schema, latestPrices] = await Promise.all([
    ...
    // Убираем одинаковые семейства с разным wear
    ...
    // ===============================
    // GET PRICES — уже загружены одним snapshot
    // ===============================
