...
const server = http.createServer(async (req, res) => {
  ...
  if (pathname === '/auth/google' && req.method === 'GET') {
    ...
    res.writeHead(302,{Location:'https://accounts.google.com/o/oauth2/v2/auth?'+params.toString(), 'Cache-Control':'no-store', 'Set-Cookie':`google_oauth_state=${state}; Path=/; HttpOnly; Secure; SameSite=Lax; Max-Age=600`});
    return res.end();
  }
  ...
  if (pathname === '/auth/google/callback' && req.method === 'GET') {
    try{
      ...
      res.writeHead(302,{
        ...
        'Set-Cookie':[`session_id=${sid}; Path=/; HttpOnly; Secure; SameSite=Lax; Max-Age=31536000`,`google_oauth_state=; Path=/; HttpOnly; Secure; SameSite=Lax; Max-Age=0`]
      });
      return res.end();
    }catch(e){
