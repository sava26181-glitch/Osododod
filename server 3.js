...
// PostgreSQL initializes in the background.
// Do NOT block HTTP requests on the database startup promise: Render/Postgres
// can be temporarily unavailable, while the frontend must still receive /api/current-user,
// the cached catalog, and the HTML.
